...
def augment_and_save_frames(video_reader,output_folder_path,video_clip_name,i,fps,w,h):
    ...
    seq = iaa.Sequential([
        iaa.Affine(shear=rotation_angle)
    ])
...
if __name__=='__main__':
    ...
    #터미널코드 예제) python augmentation.py --main-folder-path 'D:\VSwork\project-template\Sehyeon\test' --output-folder-path 'D:\VSwork\project-template\Sehyeon\datarg' --max-clips 4
