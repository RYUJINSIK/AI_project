...
뉴스를 통해서 청각장애인들이 수어를 배울 수 있는 환경이 열악하다는 소식을 접함. 수어를 배울 수 있는 농학교에서 마저 수어를 할 수 있는 선생님이 몇 안됨. 조사에 따르면 수어를 할 수 있는 청각장애인 수도 현저하게 낮았음. 조금 더 쉽게 청각장애인들이 수어를 배울 수 있는 기회를 만들어 주고 싶었음. 
